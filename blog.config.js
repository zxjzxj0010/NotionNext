...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '13c55ee0adba80f9b57fe72cb4fff834',
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://wmm.knockblog.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '王木木和闹钟钟的日记本, 博客', // 网站关键词 英文逗号隔开
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '苏ICP备2024144213号-1', // 备案号 闽ICP备XXXXXXX
